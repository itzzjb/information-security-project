...
<%
        ...
        String introUrl = "https://api.asgardeo.io/t/januda/oauth2/introspect";
     ...
     // retreiving session state from session attributes
        ...
        // Check if the tokens exist in the session
         if (access_token != null && id_token != null) {
        	    String apiUrl = "https://api.asgardeo.io/t/januda/oauth2/userinfo";
...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<ul class="navbar-nav">
				<li>
				<form id="logout-form" action="https://api.asgardeo.io/t/januda/oidc/logout" method="POST">
