        ...
        <div class="row">
            <div class="col-sm-9 col-md-4 col-lg-4 mx-auto login-sec">
                ...
                <div class="inner-div">
					...
					<button id="btn-login" class="btn btn-success" onclick="window.location.href='https://api.asgardeo.io/t/januda/oauth2/authorize?response_type=code&client_id=xvsKpS5yAgbX8qXOfRDeNI13Ul4a&scope=openid%20email%20phone%20profile&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2FAuto-Care-Vehicle-Services%2Fauthorize.jsp'" >
